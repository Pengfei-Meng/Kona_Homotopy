...
folder = '/home/pengfei/Developer/kona_mengp2/fstopo_output2/'


pcd = 'pc'                             # results from  svd_pc_cmu, or svd_pc4.py 
...
if pic_color == 1:
    if case == 'medium':
        line1, = ax.semilogy(kona_time_eye[::n_int], kona_data_eye[::n_int]['optim_inf'], '-k^', linewidth=1.0, ms=6.0, mfc='w', mew=1.0) 
        line2, = ax.semilogy(kona_time_eye[::n_int], kona_data_eye[::n_int]['complem_inf'], '--k^', linewidth=1.0, ms=6.0, mfc='w', mew=1.0)  
        line3, = ax.semilogy(kona_time_eye[::n_int], kona_data_eye[::n_int]['feas_inf'], ':k^', linewidth=1.0, ms=6.0, mfc='w', mew=1.0)     
    else: 
    ...
    line4, = ax.semilogy(kona_time_svd, kona_data_svd['optim_inf'], '-ro', linewidth=1.0, ms=6.0, mfc='w', mew=1.0) 
    ...
    line7, = ax.semilogy(snopt_time, snopt_data['optimality'], '-bs', linewidth=1.0, ms=6.0, mfc='w', mew=1.0)    
    ...
    line4, = ax.semilogy(kona_time_svd, kona_data_svd['optim_inf'], '-ko', linewidth=1.0, ms=6.0, mfc='w', mew=1.0) 
    ...
    line7, = ax.semilogy(snopt_time, snopt_data['optimality'], '-ks', linewidth=1.0, ms=6.0, mfc='w', mew=1.0)    
...
ax.yaxis.set_ticks(np.logspace(-7, 1, num=9))

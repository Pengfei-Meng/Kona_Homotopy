...
class InequalityTestCase(unittest.TestCase):
    ...
    def test_snopt(self):
        ...
        # Note that: the sequence of the above two lines 
        # can influence the time count in kona_timings.dat. don't know why. 
        # The results are generated by putting self.kona_optimize('svd_pc_cmu') first 

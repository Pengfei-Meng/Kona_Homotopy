...
dir_data = '../results4/small_eye_post/'
j = 0
scaled_slack = True
...
def mat_vec_SVD_1st(in_vec):
    ...
    # 3) LHS matrix
    W_diag = 0.01*np.ones(num_design)       # np.diag(W_approx)   
...
# line1, = ax.semilogy(range(len(res_hist)), res_hist/res_hist[0], '-k^', linewidth=1.0, ms=6.0, mfc='w', mew=1.0) 
# line2, = ax.semilogy(range(len(res_hist_pc10)), res_hist_pc10/res_hist_pc10[0], '-kv', linewidth=1.0, ms=6.0, mfc='w', mew=1.0)  
# line3, = ax.semilogy(range(len(res_hist_pc20)), res_hist_pc20/res_hist_pc20[0], '-ko', linewidth=1.0, ms=6.0, mfc='w', mew=1.0) 
# line4, = ax.semilogy(range(len(res_hist_pc30)), res_hist_pc30/res_hist_pc30[0], '-ks', linewidth=1.0, ms=6.0, mfc='w', mew=1.0)  
